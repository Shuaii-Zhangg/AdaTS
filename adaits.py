...
class AdaITS(Optimizer):
    r"""Implements AdaITS algorithm.
    Arguments:
    ...
    def __init__(self, params,  lr=1e-3, betas=(0.9, 0.999), eps=1e-8, final_lr=0.01,
        ...
        super(AdaITS, self).__init__(params, defaults)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                step_size = denom * (1 - state['step'] / iters) + (state['step'] / iters) * group['final_lr'] + delta
